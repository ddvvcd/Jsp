...
<%
	...
	String no = request.getParameter("no"); //list에서 글 번호를 넘겨 받음
	//int ano = Integer.parseInt(no);
	//ArticleDTO dto = dao.selectArticle(ano);
	...
	$(function(){
		...
		$('.mod').click(function(e){
			...
			if(txt == '수정'){
				...
				//수정 데이터 전송
				$(this).closest('form').submit(); //'수정완료 버튼'의 부모 중 가장 가까운 'form태그'
        ...
        <section class="commentList">
            ...
            <article class="comment">
            	<form action="/Jboard1/proc/commentUpdate.jsp" method="post">
            		<input type="hidden" name="no" value="<%= comment.getNo() %>"> <!-- 새로 추가 -->
            		<input type="hidden" name="parent" value="<%= comment.getParent() %>"> <!-- 새로 추가 -->
	                <span>
        ...
        <section class="commentForm">
            ...
            <form action="/Jboard1/proc/commentProc.jsp" method="post">
                ...
                <div>
                    ...
                    <input type="reset" class="btnWrite" value="reset"/>
