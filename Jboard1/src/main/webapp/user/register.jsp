...
<head>
    ...
    <script src="/Jboard1/js/checkUser.js"></script> <!-- 위의 정규표현식을 참조하기 위해서 아래쪽에 배치 -->
                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" id="btnCheckUid"><img src="../images/chk_id.gif" alt=""></button> <!-- 타입 버튼 지정해줘야함 -->
                                <span class="resultId"></span> <!-- 아이디 중복여부 확인 --> <!-- 타입 버튼 지정 안하면 submit으로 되어서 안 됨 -->
                            </td>
                        </tr>
                        <tr>
                            <td>비밀번호</td>
